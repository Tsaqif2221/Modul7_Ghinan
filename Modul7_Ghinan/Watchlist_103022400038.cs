...
namespace Modul7_Ghinan
{
    ...
    public class Watchlist_103022400038
    {
        ...
        {
            string JsonString = File.ReadAllText("jurnal7_2_103022400038.json");
            var data = JsonSerializer.Deserialize<Watchlist_103022400038>(JsonString);
